...
namespace eStore
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseStaticFiles();// su dung cac tep trong wwwroot

            app.UseSession();//su dung sesssion

            app.UseRouting();//dinh tuyen cac yeu cau HTTP

            app.UseAuthentication();//xac thuc va uy quyen
